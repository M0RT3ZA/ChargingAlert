...
import ir.morteza_aghighi.chargingalert.ViewDevicesActivity


private const val NOTIFICATION_CHANNEL_ID = "mohafez BACKGROUND SERVICE CHANNEL"
private const val IMAGE_NOTIFICATION_CHANNEL_ID = "mohafez IMAGE NOTIFICATION CHANNEL"
private const val MAIN_NOTIFICATION_REQUEST_CODE = 0
private const val MAIN_NOTIFICATION_NAME = "mohafez Service Notifications Channel"
private const val MAIN_NOTIFICATION_DESCRIPTION = "mohafez Service Channel"
...
class ServiceNotificationTools(private val context: Context) {
    ...
    private val notificationIntent = Intent(context, ViewDevicesActivity::class.java)
    ...
    fun createNotification():Notification {
        ...
        builder.setSmallIcon(drawable.splash_logo)
            .setContentTitle(context.getString(string.running))
            .setContentText(context.getString(string.running_description))
            .setContentIntent(pendingIntent)
            //Using this action button I would like to call logTest
            .addAction(
                drawable.ic_baseline_close_24,
                context.getString(string.stop_background_service), pendingExitIntent
            )
            .setOngoing(true)
